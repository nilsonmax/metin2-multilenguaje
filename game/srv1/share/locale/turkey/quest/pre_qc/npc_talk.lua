quest npc_talk begin
    state start begin
		...
		when 20018.chat."Biyoloðun etkisiz reçeteleri"   begin
			...
			wait()
			say_title("Baek-Go:")
			say("Buyrun efendim. Derin bir nefes veee mideye! Çok ")
		...
		when 20088.chat."2.Kata geç " begin
			pc.warp(704100,464000)
		end
		when 20089.chat."1.Kata dön " begin
			pc.warp(92000,525500)
		end
		when blacksmith.chat."Ben Bir þey Düzeltmek istiyorum" begin
			say_title("Demirci: ")
			say("")
			say("Merhaba!")
			say("Ben maddeleri düzeltmek için buradayým.")
			say("Bir madde düzeltmek için ")
			say("yalnýz bana gel. ")
			say("")
			say_title("Bilgi:")
			say("")
			say_reward("Maddeyi yanlýz demircinin üstüne koy.")
			say("")
		end
	end
end
