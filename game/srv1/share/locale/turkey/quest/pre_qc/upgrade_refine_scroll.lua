    ...
    state start begin
		when 20016.chat."Savaþ kaðýdý üret." begin
            ...
            if pc.count_item(70035) == 0 then
                say_title("Demirci:")
                say("Bunu üretmek için, büyülü demir madeni ihtiyacýn")
                say("var.")
                say("")
                say_item("Büyülü Demir Madeni", 70035, "")
                say("")
                wait()
				end
            ...
            say("Eðer büyülü demir madeni ve kutsama kaðýdýn varsa,")
            ...
            if 1 == s then
                ...
                elseif pc.count_item(70035)>0 and pc.count_item(25040)>0 then
                    ...
                    say("büyülü demir madeni olduðunda savaþ ")
        ...
        when 20016.chat."Ejderha Tanrýsý Kaðýdý üretmek" begin
            ...
            if pc.count_item(71026)==0 then
                say_title("Demirci:")
                say("")
                say("Bunu yapmak için büyülü demir madenine")
                say("ihtiyacýn var.")
				say("")
                say_item("Büyülü Demir Madeni", 71026, "")
                say("")
                wait()
            end
            if pc.count_item(25040)==0 then
            ...
            if 1 == ss then
                if pc.count_item(71026)>0 and pc.count_item(25040)>0 then
                    ...
                    say("Büyülü demir madeni kullandýðýn zaman,")
